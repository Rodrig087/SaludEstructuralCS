...
; payload start address is: 4 (W2)
	ZE	W13, W0
	CP	W1, W0
	BRA LTU	L__EnviarTramaRS485372
	GOTO	L_EnviarTramaRS48533
L__EnviarTramaRS485372:
...
; payload start address is: 2 (W1)
	CALL	_UART1_Tx_Idle
	CP	W0, #0
	BRA Z	L__EnviarTramaRS485373
	GOTO	L_EnviarTramaRS48536
L__EnviarTramaRS485373:
...
; payload start address is: 2 (W1)
	CP.B	W10, #2
	BRA Z	L__EnviarTramaRS485374
	GOTO	L_EnviarTramaRS48537
L__EnviarTramaRS485374:
...
; payload end address is: 2 (W1)
	ZE	W13, W0
	CP	W2, W0
	BRA LTU	L__EnviarTramaRS485375
	GOTO	L_EnviarTramaRS48539
L__EnviarTramaRS485375:
; payload end address is: 2 (W1)
...
L_EnviarTramaRS48541:
	CALL	_UART2_Tx_Idle
	CP	W0, #0
	BRA Z	L__EnviarTramaRS485376
	GOTO	L_EnviarTramaRS48542
L__EnviarTramaRS485376:
...
;Master.c,105 :: 		ConfiguracionPrincipal();
	CALL	_ConfiguracionPrincipal
;Master.c,106 :: 		DS3234_init();
	CALL	_DS3234_init
;Master.c,112 :: 		i = 0;
	CLR	W0
	MOV	W0, _i
...
;Master.c,115 :: 		y = 0;
	CLR	W0
	MOV	W0, _y
;Master.c,118 :: 		banSPI0 = 0;
	MOV	#lo_addr(_banSPI0), W1
	CLR	W0
	MOV.B	W0, [W1]
;Master.c,119 :: 		banSPI1 = 0;
	MOV	#lo_addr(_banSPI1), W1
	CLR	W0
	MOV.B	W0, [W1]
;Master.c,120 :: 		banSPI2 = 0;
	MOV	#lo_addr(_banSPI2), W1
	CLR	W0
	MOV.B	W0, [W1]
;Master.c,121 :: 		banSPI3 = 0;
	MOV	#lo_addr(_banSPI3), W1
	CLR	W0
	MOV.B	W0, [W1]
;Master.c,122 :: 		banSPI4 = 0;
	MOV	#lo_addr(_banSPI4), W1
	CLR	W0
	MOV.B	W0, [W1]
;Master.c,123 :: 		banSPI5 = 0;
	MOV	#lo_addr(_banSPI5), W1
	CLR	W0
	MOV.B	W0, [W1]
;Master.c,124 :: 		banSPI6 = 0;
	MOV	#lo_addr(_banSPI6), W1
	CLR	W0
	MOV.B	W0, [W1]
;Master.c,125 :: 		banSPI7 = 0;
	MOV	#lo_addr(_banSPI7), W1
	CLR	W0
	MOV.B	W0, [W1]
;Master.c,126 :: 		banSPI8 = 0;
	MOV	#lo_addr(_banSPI8), W1
	CLR	W0
	MOV.B	W0, [W1]
;Master.c,127 :: 		banSPI9 = 0;
	MOV	#lo_addr(_banSPI9), W1
	CLR	W0
	MOV.B	W0, [W1]
;Master.c,128 :: 		banSPIA = 0;
	MOV	#lo_addr(_banSPIA), W1
	CLR	W0
	MOV.B	W0, [W1]
;Master.c,131 :: 		i_gps = 0;
	CLR	W0
	MOV	W0, _i_gps
;Master.c,132 :: 		byteGPS = 0;
	MOV	#lo_addr(_byteGPS), W1
	CLR	W0
	MOV.B	W0, [W1]
;Master.c,133 :: 		banTIGPS = 0;
	MOV	#lo_addr(_banTIGPS), W1
	CLR	W0
	MOV.B	W0, [W1]
;Master.c,134 :: 		banTFGPS = 0;
	MOV	#lo_addr(_banTFGPS), W1
	CLR	W0
	MOV.B	W0, [W1]
;Master.c,135 :: 		banTCGPS = 0;
...
;Master.c,152 :: 		subFuncionRS485 = 0;
	...
	CLR	W0
	MOV.B	W0, [W1]
;Master.c,155 :: 		banInicioMuestreo = 0;
	MOV	#lo_addr(_banInicioMuestreo), W1
	CLR	W0
	MOV.B	W0, [W1]
;Master.c,158 :: 		RP1 = 0;
	BCLR	LATA4_bit, BitPos(LATA4_bit+0)
;Master.c,159 :: 		INT_SINC = 1;                                                              //Enciende el pin TEST
	BSET	LATA1_bit, BitPos(LATA1_bit+0)
;Master.c,160 :: 		INT_SINC1 = 0;                                                             //Inicializa los pines de sincronizacion en 0
	BCLR	LATA0_bit, BitPos(LATA0_bit+0)
;Master.c,161 :: 		INT_SINC2 = 0;
	BCLR	LATA3_bit, BitPos(LATA3_bit+0)
;Master.c,162 :: 		INT_SINC3 = 0;
	BCLR	LATB10_bit, BitPos(LATB10_bit+0)
;Master.c,163 :: 		INT_SINC4 = 0;
	BCLR	LATB12_bit, BitPos(LATB12_bit+0)
;Master.c,165 :: 		MSRS485 = 0;                                                               //Establece el Max485 en modo de lectura;
	BCLR	LATB11_bit, BitPos(LATB11_bit+0)
;Master.c,167 :: 		SPI1BUF = 0x00;
	CLR	SPI1BUF
;Master.c,169 :: 		while(1){
L_main43:
;Master.c,172 :: 		}
	GOTO	L_main43
;Master.c,174 :: 		}
...
;Master.c,183 :: 		void ConfiguracionPrincipal(){
;Master.c,186 :: 		CLKDIVbits.FRCDIV = 0;                                                     //FIN=FRC/1
	PUSH	W10
	PUSH	W11
	PUSH	W12
	PUSH	W13
	...
	AND	W1, W0, W0
	MOV	WREG, CLKDIVbits
;Master.c,187 :: 		CLKDIVbits.PLLPOST = 0;                                                    //N2=2
	...
	MOV	#lo_addr(CLKDIVbits), W0
	MOV.B	W1, [W0]
;Master.c,188 :: 		CLKDIVbits.PLLPRE = 5;                                                     //N1=7
	MOV.B	#5, W0
	MOV.B	W0, W1
	MOV	#lo_addr(CLKDIVbits), W0
	XOR.B	W1, [W0], W1
	...
	MOV	#lo_addr(CLKDIVbits), W0
	MOV.B	W1, [W0]
;Master.c,189 :: 		PLLFBDbits.PLLDIV = 150;                                                   //M=152
	MOV	#150, W0
	MOV	W0, W1
	...
	XOR	W1, [W0], W1
	MOV	W1, PLLFBDbits
;Master.c,192 :: 		ANSELA = 0;                                                                //Configura PORTA como digital     *
	CLR	ANSELA
;Master.c,193 :: 		ANSELB = 0;                                                                //Configura PORTB como digital     *
	CLR	ANSELB
;Master.c,195 :: 		TRISA2_bit = 0;                                                            //RTC_CS
	BCLR	TRISA2_bit, BitPos(TRISA2_bit+0)
;Master.c,196 :: 		INT_SINC_Direction = 0;                                                    //INT_SINC
	BCLR	TRISA1_bit, BitPos(TRISA1_bit+0)
;Master.c,197 :: 		INT_SINC1_Direction = 0;                                                   //INT_SINC1
	BCLR	TRISA0_bit, BitPos(TRISA0_bit+0)
;Master.c,198 :: 		INT_SINC2_Direction = 0;                                                   //INT_SINC2
	BCLR	TRISA3_bit, BitPos(TRISA3_bit+0)
;Master.c,199 :: 		INT_SINC3_Direction = 0;                                                   //INT_SINC3
	BCLR	TRISB10_bit, BitPos(TRISB10_bit+0)
;Master.c,200 :: 		INT_SINC4_Direction = 0;                                                   //INT_SINC4
	BCLR	TRISB12_bit, BitPos(TRISB12_bit+0)
;Master.c,201 :: 		RP1_Direction = 0;                                                         //RP1
	BCLR	TRISA4_bit, BitPos(TRISA4_bit+0)
;Master.c,202 :: 		MSRS485_Direction = 0;                                                     //MSRS485
...
;Master.c,211 :: 		RPOR0bits.RP35R = 0x01;                                                    //Configura el Tx1 en el pin RB3/RP35
	...
	XOR	W1, [W0], W1
	MOV	W1, RPOR0bits
;Master.c,212 :: 		U1RXIE_bit = 0;                                                            //Habilita la interrupcion UART1 RX
	BCLR	U1RXIE_bit, BitPos(U1RXIE_bit+0)
;Master.c,213 :: 		U1RXIF_bit = 0;                                                            //Limpia la bandera de interrupcion por UART1 RX
...
;Master.c,245 :: 		IPC5bits.INT1IP = 0x01;                                                    //Prioridad en la interrupocion externa 1
	MOV.B	#1, W0
	MOV.B	W0, W1
	...
	MOV	#lo_addr(IPC5bits), W0
	MOV.B	W1, [W0]
;Master.c,248 :: 		SPI1IE_bit = 1;                                                            //SPI1
	BSET	SPI1IE_bit, BitPos(SPI1IE_bit+0)
;Master.c,249 :: 		INT1IE_bit = 0;                                                            //INT1
	BCLR	INT1IE_bit, BitPos(INT1IE_bit+0)
;Master.c,251 :: 		Delay_ms(200);                                                             //Espera hasta que se estabilicen los cambios
	MOV	#25, W8
	MOV	#27150, W7
...
;Master.c,258 :: 		void InterrupcionP1(unsigned short funcionSPI, unsigned short subFuncionSPI, unsigned int numBytesSPI){
;Master.c,261 :: 		if ((funcionSPI==0xB1)&&(subFuncionSPI==0xD1)){
	PUSH	W13
	MOV.B	#177, W0
	CP.B	W10, W0
	BRA Z	L__InterrupcionP1381
	GOTO	L__InterrupcionP1214
L__InterrupcionP1381:
	MOV.B	#209, W0
	CP.B	W11, W0
	BRA Z	L__InterrupcionP1382
	GOTO	L__InterrupcionP1213
L__InterrupcionP1382:
L__InterrupcionP1212:
;Master.c,262 :: 		if (INT1IE_bit==0){
	BTSC	INT1IE_bit, BitPos(INT1IE_bit+0)
	GOTO	L_InterrupcionP150
;Master.c,263 :: 		INT1IE_bit = 1;
	BSET	INT1IE_bit, BitPos(INT1IE_bit+0)
;Master.c,264 :: 		}
L_InterrupcionP150:
;Master.c,266 :: 		outputPyloadRS485[0] = 0xD1;
	MOV	#lo_addr(_outputPyloadRS485), W1
	MOV.B	#209, W0
	MOV.B	W0, [W1]
;Master.c,267 :: 		for (x=1;x<7;x++){
	MOV	#1, W0
	MOV	W0, _x
L_InterrupcionP151:
	MOV	_x, W0
	CP	W0, #7
	BRA LTU	L__InterrupcionP1383
	GOTO	L_InterrupcionP152
L__InterrupcionP1383:
;Master.c,268 :: 		outputPyloadRS485[x] = tiempo[x-1];
	MOV	#lo_addr(_outputPyloadRS485), W1
	MOV	#lo_addr(_x), W0
	ADD	W1, [W0], W2
	MOV	_x, W0
...
L_InterrupcionP152:
;Master.c,270 :: 		EnviarTramaRS485(2, 255, 0xF1, 7, outputPyloadRS485);                   //Envia la hora local a los nodos
	PUSH	W12
	PUSH.D	W10
	MOV.B	#7, W13
	MOV.B	#241, W12
	...
	POP	W12
;Master.c,261 :: 		if ((funcionSPI==0xB1)&&(subFuncionSPI==0xD1)){
L__InterrupcionP1214:
L__InterrupcionP1213:
;Master.c,274 :: 		ptrnumBytesSPI = (unsigned char *) & numBytesSPI;
	MOV	#lo_addr(W12), W2
	MOV	W2, _ptrnumBytesSPI
;Master.c,277 :: 		tramaSolicitudSPI[0] = funcionSPI;                                         //Operacion solicitada
	MOV	#lo_addr(_tramaSolicitudSPI), W0
	MOV.B	W10, [W0]
;Master.c,278 :: 		tramaSolicitudSPI[1] = subFuncionSPI;                                      //Subfuncion solicitada
	MOV	#lo_addr(_tramaSolicitudSPI+1), W0
	MOV.B	W11, [W0]
;Master.c,279 :: 		tramaSolicitudSPI[2] = *(ptrnumBytesSPI);                                  //LSB numBytesSPI
	MOV.B	[W2], W1
	MOV	#lo_addr(_tramaSolicitudSPI+2), W0
	MOV.B	W1, [W0]
;Master.c,280 :: 		tramaSolicitudSPI[3] = *(ptrnumBytesSPI+1);                                //MSB numBytesSPI
	ADD	W2, #1, W0
	MOV.B	[W0], W1
...
;Master.c,297 :: 		void spi_1() org  IVT_ADDR_SPI1INTERRUPT {
;Master.c,299 :: 		SPI1IF_bit = 0;                                                            //Limpia la bandera de interrupcion por SPI
	PUSH	W10
	PUSH	W11
	PUSH	W12
	PUSH	W13
	BCLR	SPI1IF_bit, BitPos(SPI1IF_bit+0)
;Master.c,300 :: 		bufferSPI = SPI1BUF;                                                       //Guarda el contenido del bufeer (lectura)
	MOV	#lo_addr(_bufferSPI), W1
	MOV.B	SPI1BUF, WREG
	MOV.B	W0, [W1]
;Master.c,304 :: 		if ((banSPI0==0)&&(bufferSPI==0xA0)) {
...
L__spi_1386:
L__spi_1248:
;Master.c,305 :: 		banSPI0 = 1;                                                            //Activa la bandera para enviar el tipo de operacion requerido a la RPi
	MOV	#lo_addr(_banSPI0), W1
	MOV.B	#1, W0
	MOV.B	W0, [W1]
;Master.c,306 :: 		i = 1;
	MOV	#1, W0
	MOV	W0, _i
;Master.c,307 :: 		SPI1BUF = tramaSolicitudSPI[0];                                         //Carga en el buffer la funcion requerida
	MOV	#lo_addr(_tramaSolicitudSPI), W0
	ZE	[W0], W0
	MOV	WREG, SPI1BUF
;Master.c,304 :: 		if ((banSPI0==0)&&(bufferSPI==0xA0)) {
L__spi_1250:
L__spi_1249:
;Master.c,309 :: 		if ((banSPI0==1)&&(bufferSPI!=0xA0)&&(bufferSPI!=0xF0)){
	MOV	#lo_addr(_banSPI0), W0
	MOV.B	[W0], W0
	CP.B	W0, #1
	BRA Z	L__spi_1387
...
L__spi_1389:
L__spi_1247:
;Master.c,310 :: 		SPI1BUF = tramaSolicitudSPI[i];                                         //Se envia la subfuncion, y el LSB y MSB de la variable numBytesSPI
...
L__spi_1252:
L__spi_1251:
;Master.c,313 :: 		if ((banSPI0==1)&&(bufferSPI==0xF0)){
	MOV	#lo_addr(_banSPI0), W0
	MOV.B	[W0], W0
	CP.B	W0, #1
	BRA Z	L__spi_1390
...
L__spi_1391:
L__spi_1246:
;Master.c,314 :: 		banSPI0 = 0;                                                            //Limpia la bandera
	MOV	#lo_addr(_banSPI0), W1
	CLR	W0
	MOV.B	W0, [W1]
;Master.c,313 :: 		if ((banSPI0==1)&&(bufferSPI==0xF0)){
...
L__spi_1396:
L__spi_1244:
;Master.c,327 :: 		tramaSolicitudSPI[i] = bufferSPI;                                       //Recupera la direccion del nodo y el indicador de sobrescritura de la SD
	MOV	#lo_addr(_tramaSolicitudSPI), W1
	MOV	#lo_addr(_i), W0
	ADD	W1, [W0], W1
	MOV	#lo_addr(_bufferSPI), W0
...
L__spi_1398:
L__spi_1243:
;Master.c,331 :: 		direccionRS485 = tramaSolicitudSPI[0];
	MOV	#lo_addr(_direccionRS485), W1
	MOV	#lo_addr(_tramaSolicitudSPI), W0
	MOV.B	[W0], [W1]
;Master.c,332 :: 		outputPyloadRS485[0] = 0xD1;                                            //Subfuncion iniciar muestreo
	MOV	#lo_addr(_outputPyloadRS485), W1
	MOV.B	#209, W0
	MOV.B	W0, [W1]
;Master.c,333 :: 		outputPyloadRS485[1] = tramaSolicitudSPI[1];                            //Payload sobrescribir SD
	MOV	#lo_addr(_outputPyloadRS485+1), W1
	MOV	#lo_addr(_tramaSolicitudSPI+1), W0
	MOV.B	[W0], [W1]
;Master.c,334 :: 		EnviarTramaRS485(2, direccionRS485, 0xF2, 2, outputPyloadRS485);        //Envia la solicitud al nodo
	MOV	#lo_addr(_tramaSolicitudSPI), W0
	MOV.B	#2, W13
	MOV.B	#242, W12
	MOV.B	[W0], W11
...
L__spi_1262:
L__spi_1261:
;Master.c,339 :: 		if ((banSPI2==0)&&(bufferSPI==0xA2)){
...
L__spi_1264:
L__spi_1263:
;Master.c,343 :: 		if ((banSPI2==1)&&(bufferSPI!=0xA2)&&(bufferSPI!=0xF2)){
	MOV	#lo_addr(_banSPI2), W0
	MOV.B	[W0], W0
	CP.B	W0, #1
	BRA Z	L__spi_1401
...
L__spi_1403:
L__spi_1241:
;Master.c,344 :: 		tramaSolicitudSPI[i] = bufferSPI;                                       //Recupera la direccion del nodo
	MOV	#lo_addr(_tramaSolicitudSPI), W1
	MOV	#lo_addr(_i), W0
	ADD	W1, [W0], W1
	MOV	#lo_addr(_bufferSPI), W0
...
L__spi_1266:
L__spi_1265:
;Master.c,346 :: 		if ((banSPI2==1)&&(bufferSPI==0xF2)){
	MOV	#lo_addr(_banSPI2), W0
	MOV.B	[W0], W0
	CP.B	W0, #1
	BRA Z	L__spi_1404
...
L__spi_1405:
L__spi_1240:
;Master.c,347 :: 		direccionRS485 = tramaSolicitudSPI[0];
	MOV	#lo_addr(_direccionRS485), W1
	MOV	#lo_addr(_tramaSolicitudSPI), W0
	MOV.B	[W0], [W1]
;Master.c,348 :: 		outputPyloadRS485[0] = 0xD2;                                            //Subfuncion detener muestreo
	MOV	#lo_addr(_outputPyloadRS485), W1
	MOV.B	#210, W0
	MOV.B	W0, [W1]
;Master.c,349 :: 		EnviarTramaRS485(2, direccionRS485, 0xF2, 1, outputPyloadRS485);        //Envia la solicitud al nodo
	MOV	#lo_addr(_tramaSolicitudSPI), W0
	MOV.B	#1, W13
	MOV.B	#242, W12
	MOV.B	[W0], W11
...
L__spi_1269:
L__spi_1268:
;Master.c,354 :: 		if ((banLec==1)&&(bufferSPI==0xA3)){                                       //Verifica si la bandera de inicio de trama esta activa
...
L__spi_1407:
L__spi_1239:
;Master.c,355 :: 		banLec = 2;                                                             //Activa la bandera de lectura
...
;Master.c,356 :: 		i = 0;
	CLR	W0
	MOV	W0, _i
;Master.c,357 :: 		SPI1BUF = tramaCompleta[i];                                             //**Aqui envio a la RPi la trama de aceleracion recuperada de los nodos
...
L__spi_1271:
L__spi_1270:
;Master.c,359 :: 		if ((banLec==2)&&(bufferSPI!=0xF3)){
	MOV	#lo_addr(_banLec), W0
	MOV.B	[W0], W0
	CP.B	W0, #2
	BRA Z	L__spi_1408
...
L__spi_1409:
L__spi_1238:
;Master.c,360 :: 		SPI1BUF = tramaCompleta[i];
	MOV	#lo_addr(_tramaCompleta), W1
	MOV	#lo_addr(_i), W0
	ADD	W1, [W0], W0
	MOV.B	[W0], W0
...
L__spi_1273:
L__spi_1272:
;Master.c,363 :: 		if ((banLec==2)&&(bufferSPI==0xF3)){                                       //Si detecta el delimitador de final de trama:
	MOV	#lo_addr(_banLec), W0
	MOV.B	[W0], W0
	CP.B	W0, #2
	BRA Z	L__spi_1410
...
L__spi_1411:
L__spi_1237:
;Master.c,364 :: 		banLec = 0;                                                             //Limpia la bandera de lectura
	MOV	#lo_addr(_banLec), W1
	CLR	W0
	MOV.B	W0, [W1]
;Master.c,365 :: 		SPI1BUF = 0xFF;
	MOV	#255, W0
	MOV	WREG, SPI1BUF
;Master.c,363 :: 		if ((banLec==2)&&(bufferSPI==0xF3)){                                       //Si detecta el delimitador de final de trama:
L__spi_1275:
L__spi_1274:
;Master.c,374 :: 		if ((banSetReloj==0)&&(bufferSPI==0xA4)){
...
L__spi_1277:
L__spi_1276:
;Master.c,378 :: 		if ((banSPI4==1)&&(bufferSPI!=0xA4)&&(bufferSPI!=0xF4)){
...
L__spi_1416:
L__spi_1235:
;Master.c,379 :: 		tiempoRPI[j] = bufferSPI;
...
L__spi_1279:
L__spi_1278:
;Master.c,382 :: 		if ((banSPI4==1)&&(bufferSPI==0xF4)){
	MOV	#lo_addr(_banSPI4), W0
	MOV.B	[W0], W0
	CP.B	W0, #1
	BRA Z	L__spi_1417
...
L__spi_1418:
L__spi_1234:
;Master.c,383 :: 		horaSistema = RecuperarHoraRPI(tiempoRPI);                              //Recupera la hora de la RPi
	MOV	#lo_addr(_tiempoRPI), W10
	CALL	_RecuperarHoraRPI
	MOV	W0, _horaSistema
	MOV	W1, _horaSistema+2
;Master.c,384 :: 		fechaSistema = RecuperarFechaRPI(tiempoRPI);                            //Recupera la fecha de la RPi
	MOV	#lo_addr(_tiempoRPI), W10
	CALL	_RecuperarFechaRPI
	MOV	W0, _fechaSistema
	MOV	W1, _fechaSistema+2
;Master.c,385 :: 		DS3234_setDate(horaSistema, fechaSistema);                              //Configura la hora en el RTC
	MOV.D	W0, W12
	MOV	_horaSistema, W10
	MOV	_horaSistema+2, W11
	CALL	_DS3234_setDate
;Master.c,386 :: 		horaSistema = RecuperarHoraRTC();                                       //Recupera la hora del RTC
	CALL	_RecuperarHoraRTC
	MOV	W0, _horaSistema
	MOV	W1, _horaSistema+2
;Master.c,387 :: 		fechaSistema = RecuperarFechaRTC();                                     //Recupera la fecha del RTC
...
L__spi_1303:
L__spi_1302:
;Master.c,455 :: 		if ((banSPI8==0)&&(bufferSPI==0xA8)){
...
L__spi_1305:
L__spi_1304:
;Master.c,459 :: 		if ((banSPI8==1)&&(bufferSPI!=0xA8)&&(bufferSPI!=0xF8)){
	MOV	#lo_addr(_banSPI8), W0
	MOV.B	[W0], W0
	CP.B	W0, #1
	BRA Z	L__spi_1443
...
L__spi_1445:
L__spi_1223:
;Master.c,460 :: 		tramaSolicitudNodo[i] = bufferSPI;                                      //Recupera la trama de solicitud enviada por la RPi
...
L__spi_1307:
L__spi_1306:
;Master.c,463 :: 		if ((banSPI8==1)&&(bufferSPI==0xF8)){
	MOV	#lo_addr(_banSPI8), W0
	MOV.B	[W0], W0
	CP.B	W0, #1
	BRA Z	L__spi_1446
...
L__spi_1447:
L__spi_1222:
;Master.c,464 :: 		banSPI8 = 0;
	MOV	#lo_addr(_banSPI8), W1
	CLR	W0
	MOV.B	W0, [W1]
;Master.c,465 :: 		direccionRS485 = tramaSolicitudNodo[0];
	MOV	#lo_addr(_direccionRS485), W1
	MOV	#lo_addr(_tramaSolicitudNodo), W0
	MOV.B	[W0], [W1]
;Master.c,466 :: 		funcionRS485 = tramaSolicitudNodo[1];
	MOV	#lo_addr(_funcionRS485), W1
	MOV	#lo_addr(_tramaSolicitudNodo+1), W0
	MOV.B	[W0], [W1]
;Master.c,467 :: 		numDatosRS485 = tramaSolicitudNodo[2];
	MOV	#lo_addr(_tramaSolicitudNodo+2), W0
	ZE	[W0], W0
	MOV	W0, _numDatosRS485
;Master.c,469 :: 		if (numDatosRS485>1){
	MOV	_numDatosRS485, W0
	CP	W0, #1
	BRA GTU	L__spi_1448
	GOTO	L_spi_1140
L__spi_1448:
;Master.c,470 :: 		for (x=0;x<numDatosRS485;x++){
	CLR	W0
	MOV	W0, _x
L_spi_1141:
	MOV	_x, W1
	...
	GOTO	L_spi_1142
L__spi_1449:
;Master.c,471 :: 		outputPyloadRS485[x] = tramaSolicitudSPI[x+3];
	MOV	#lo_addr(_outputPyloadRS485), W1
	MOV	#lo_addr(_x), W0
	ADD	W1, [W0], W2
	MOV	_x, W0
...
;Master.c,473 :: 		} else {
	GOTO	L_spi_1144
L_spi_1140:
;Master.c,474 :: 		outputPyloadRS485[0] = tramaSolicitudNodo[3];
	MOV	#lo_addr(_outputPyloadRS485), W1
	MOV	#lo_addr(_tramaSolicitudNodo+3), W0
	MOV.B	[W0], [W1]
;Master.c,475 :: 		}
L_spi_1144:
;Master.c,477 :: 		EnviarTramaRS485(2, direccionRS485, funcionRS485, numDatosRS485, outputPyloadRS485);
	MOV	#lo_addr(_funcionRS485), W1
	MOV	#lo_addr(_direccionRS485), W0
...
L__spi_1310:
L__spi_1309:
;Master.c,484 :: 		if ((banSPIA==0)&&(bufferSPI==0xAA)){
...
L__spi_1451:
L__spi_1221:
;Master.c,485 :: 		banSPIA = 1;
	MOV	#lo_addr(_banSPIA), W1
	MOV.B	#1, W0
	MOV.B	W0, [W1]
;Master.c,486 :: 		SPI1BUF = inputPyloadRS485[0];
...
L__spi_1312:
L__spi_1311:
;Master.c,489 :: 		if ((banSPIA==1)&&(bufferSPI!=0xAA)&&(bufferSPI!=0xFA)){
	MOV	#lo_addr(_banSPIA), W0
	MOV.B	[W0], W0
	CP.B	W0, #1
	BRA Z	L__spi_1452
...
L__spi_1454:
L__spi_1220:
;Master.c,490 :: 		SPI1BUF = inputPyloadRS485[i];
...
L__spi_1314:
L__spi_1313:
;Master.c,493 :: 		if ((banSPIA==1)&&(bufferSPI==0xFA)){
	MOV	#lo_addr(_banSPIA), W0
	MOV.B	[W0], W0
	CP.B	W0, #1
	BRA Z	L__spi_1455
...
L__spi_1317:
L__spi_1316:
;Master.c,503 :: 		if ((banCheckRS485==0)&&(bufferSPI==0xA8)){
...
L__spi_1319:
L__spi_1318:
;Master.c,513 :: 		if ((banCheckRS485==1)&&(bufferSPI==0xA9)){
	MOV	#lo_addr(_banCheckRS485), W0
	MOV.B	[W0], W0
	CP.B	W0, #1
	BRA Z	L__spi_1459
...
;Master.c,514 :: 		j = 0;
	CLR	W0
	MOV	W0, _j
;Master.c,515 :: 		SPI1BUF = tramaPrueba[j];
...
L__spi_1321:
L__spi_1320:
;Master.c,518 :: 		if ((banCheckRS485==1)&&(bufferSPI!=0xA9)&&(bufferSPI!=0xF9)){
	MOV	#lo_addr(_banCheckRS485), W0
	MOV.B	[W0], W0
	CP.B	W0, #1
	BRA Z	L__spi_1461
...
L__spi_1463:
L__spi_1216:
;Master.c,519 :: 		SPI1BUF = tramaPrueba[j];
	MOV	#lo_addr(_tramaPrueba), W1
	MOV	#lo_addr(_j), W0
	ADD	W1, [W0], W0
	MOV.B	[W0], W0
...
L__spi_1323:
L__spi_1322:
;Master.c,522 :: 		if ((banCheckRS485==1)&&(bufferSPI==0xF9)){
	MOV	#lo_addr(_banCheckRS485), W0
	MOV.B	[W0], W0
	CP.B	W0, #1
	BRA Z	L__spi_1464
...
;Master.c,537 :: 		void int_1() org IVT_ADDR_INT1INTERRUPT {
;Master.c,539 :: 		INT1IF_bit = 0;                                                            //Limpia la bandera de interrupcion externa INT1
	BCLR	INT1IF_bit, BitPos(INT1IF_bit+0)
;Master.c,541 :: 		horaSistema++;                                                             //Incrementa el reloj del sistema
	MOV	#1, W1
	MOV	#0, W2
	MOV	#lo_addr(_horaSistema), W0
	ADD	W1, [W0], [W0++]
	ADDC	W2, [W0], [W0--]
;Master.c,542 :: 		INT_SINC = ~INT_SINC;                                                      //TEST
	BTG	LATA1_bit, BitPos(LATA1_bit+0)
;Master.c,546 :: 		INT_SINC1 = 1;
	BSET	LATA0_bit, BitPos(LATA0_bit+0)
;Master.c,547 :: 		INT_SINC2 = 1;
	BSET	LATA3_bit, BitPos(LATA3_bit+0)
;Master.c,548 :: 		INT_SINC3 = 1;
	BSET	LATB10_bit, BitPos(LATB10_bit+0)
;Master.c,549 :: 		INT_SINC4 = 1;
	BSET	LATB12_bit, BitPos(LATB12_bit+0)
;Master.c,550 :: 		Delay_us(20);
	MOV	#160, W7
L_int_1166:
	DEC	W7
	BRA NZ	L_int_1166
	NOP
	NOP
;Master.c,552 :: 		INT_SINC1 = 0;
	BCLR	LATA0_bit, BitPos(LATA0_bit+0)
;Master.c,553 :: 		INT_SINC2 = 0;
	BCLR	LATA3_bit, BitPos(LATA3_bit+0)
;Master.c,554 :: 		INT_SINC3 = 0;
	BCLR	LATB10_bit, BitPos(LATB10_bit+0)
;Master.c,555 :: 		INT_SINC4 = 0;
	BCLR	LATB12_bit, BitPos(LATB12_bit+0)
;Master.c,557 :: 		if (horaSistema==86400){                                                   //(24*3600)+(0*60)+(0) = 86400
	MOV	_horaSistema, W2
	...
	GOTO	L_int_1168
L__int_1467:
;Master.c,558 :: 		horaSistema = 0;                                                        //Reinicia el reloj al llegar a las 24:00:00 horas
	CLR	W0
	CLR	W1
	MOV	W0, _horaSistema
	MOV	W1, _horaSistema+2
...
;Master.c,652 :: 		void urx_2() org  IVT_ADDR_U2RXINTERRUPT {
;Master.c,655 :: 		U2RXIF_bit = 0;                                                            //Limpia la bandera de interrupcion por UART2
	PUSH	W10
	PUSH	W11
	PUSH	W12
	BCLR	U2RXIF_bit, BitPos(U2RXIF_bit+0)
;Master.c,656 :: 		byteRS485 = U2RXREG;                                                       //Lee el byte de la trama enviada por el nodo
	MOV	#lo_addr(_byteRS485), W1
	MOV.B	U2RXREG, WREG
	MOV.B	W0, [W1]
;Master.c,657 :: 		U2STA.OERR = 0;                                                            //Limpia este bit para limpiar el FIFO UART2
	BCLR	U2STA, #1
;Master.c,660 :: 		if (banRSI==2){
	...
	GOTO	L_urx_2170
L__urx_2470:
;Master.c,661 :: 		if (i_rs485<numDatosRS485){
	MOV	_i_rs485, W1
	MOV	#lo_addr(_numDatosRS485), W0
	CP	W1, [W0]
	BRA LTU	L__urx_2471
	GOTO	L_urx_2171
L__urx_2471:
;Master.c,662 :: 		inputPyloadRS485[i_rs485] = byteRS485;
	MOV	#lo_addr(_inputPyloadRS485), W1
	MOV	#lo_addr(_i_rs485), W0
	ADD	W1, [W0], W1
	MOV	#lo_addr(_byteRS485), W0
	MOV.B	[W0], [W1]
;Master.c,663 :: 		i_rs485++;
	MOV	#1, W1
	MOV	#lo_addr(_i_rs485), W0
	ADD	W1, [W0], [W0]
;Master.c,664 :: 		} else {
	GOTO	L_urx_2172
L_urx_2171:
;Master.c,665 :: 		banRSI = 0;                                                          //Limpia la bandera de inicio de trama
	MOV	#lo_addr(_banRSI), W1
	CLR	W0
	MOV.B	W0, [W1]
;Master.c,666 :: 		banRSC = 1;                                                          //Activa la bandera de trama completa
	MOV	#lo_addr(_banRSC), W1
	MOV.B	#1, W0
	MOV.B	W0, [W1]
;Master.c,667 :: 		}
...
;Master.c,668 :: 		}
L_urx_2170:
;Master.c,671 :: 		if ((banRSI==0)&&(banRSC==0)){
	MOV	#lo_addr(_banRSI), W0
	MOV.B	[W0], W0
	CP.B	W0, #0
	BRA Z	L__urx_2472
...
L__urx_2473:
L__urx_2329:
;Master.c,672 :: 		if (byteRS485==0x3A){                                                   //Verifica si el primer byte recibido sea la cabecera de trama
	MOV	#lo_addr(_byteRS485), W0
	MOV.B	[W0], W1
	MOV.B	#58, W0
	CP.B	W1, W0
	...
	GOTO	L_urx_2176
L__urx_2474:
;Master.c,673 :: 		banRSI = 1;
	MOV	#lo_addr(_banRSI), W1
	MOV.B	#1, W0
	MOV.B	W0, [W1]
;Master.c,674 :: 		i_rs485 = 0;
	CLR	W0
	MOV	W0, _i_rs485
;Master.c,675 :: 		}
L_urx_2176:
...
L__urx_2331:
L__urx_2330:
;Master.c,677 :: 		if ((banRSI==1)&&(i_rs485<4)){
	MOV	#lo_addr(_banRSI), W0
	MOV.B	[W0], W0
	CP.B	W0, #1
	BRA Z	L__urx_2475
...
L__urx_2476:
L__urx_2328:
;Master.c,678 :: 		tramaCabeceraRS485[i_rs485] = byteRS485;                                 //Recupera los datos de cabecera de la trama UART: [0x3A, Direccion, Funcion, NumeroDatos]
	MOV	#lo_addr(_tramaCabeceraRS485), W1
	MOV	#lo_addr(_i_rs485), W0
	ADD	W1, [W0], W1
	MOV	#lo_addr(_byteRS485), W0
	MOV.B	[W0], [W1]
;Master.c,679 :: 		i_rs485++;
	MOV	#1, W1
	MOV	#lo_addr(_i_rs485), W0
	ADD	W1, [W0], [W0]
;Master.c,677 :: 		if ((banRSI==1)&&(i_rs485<4)){
L__urx_2333:
L__urx_2332:
;Master.c,681 :: 		if ((banRSI==1)&&(i_rs485==4)){
	MOV	#lo_addr(_banRSI), W0
	MOV.B	[W0], W0
	CP.B	W0, #1
	BRA Z	L__urx_2477
...
L__urx_2478:
L__urx_2327:
;Master.c,683 :: 		if (tramaCabeceraRS485[1]==direccionRS485){
	...
	GOTO	L_urx_2183
L__urx_2479:
;Master.c,684 :: 		funcionRS485 = tramaCabeceraRS485[2];
	MOV	#lo_addr(_funcionRS485), W1
	MOV	#lo_addr(_tramaCabeceraRS485+2), W0
	MOV.B	[W0], [W1]
;Master.c,685 :: 		numDatosRS485 = tramaCabeceraRS485[3];
	MOV	#lo_addr(_tramaCabeceraRS485+3), W0
	ZE	[W0], W0
	MOV	W0, _numDatosRS485
;Master.c,686 :: 		banRSI = 2;
	MOV	#lo_addr(_banRSI), W1
	MOV.B	#2, W0
	MOV.B	W0, [W1]
;Master.c,687 :: 		i_rs485 = 0;
	CLR	W0
	MOV	W0, _i_rs485
;Master.c,688 :: 		} else {
	GOTO	L_urx_2184
L_urx_2183:
;Master.c,689 :: 		banRSI = 0;
	MOV	#lo_addr(_banRSI), W1
	CLR	W0
	MOV.B	W0, [W1]
;Master.c,690 :: 		banRSC = 0;
	MOV	#lo_addr(_banRSC), W1
	CLR	W0
	MOV.B	W0, [W1]
;Master.c,691 :: 		i_rs485 = 0;
	CLR	W0
	MOV	W0, _i_rs485
;Master.c,692 :: 		}
L_urx_2184:
...
;Master.c,696 :: 		if (banRSC==1){
	...
	GOTO	L_urx_2185
L__urx_2480:
;Master.c,697 :: 		subFuncionRS485 = inputPyloadRS485[0];
	MOV	#lo_addr(_subFuncionRS485), W1
	MOV	#lo_addr(_inputPyloadRS485), W0
	MOV.B	[W0], [W1]
;Master.c,698 :: 		switch (funcionRS485){
	GOTO	L_urx_2186
;Master.c,699 :: 		case 0xF1:
L_urx_2188:
;Master.c,709 :: 		InterrupcionP1(0xB1,subFuncionRS485,numDatosRS485);
...
;Master.c,710 :: 		break;
	GOTO	L_urx_2187
;Master.c,711 :: 		case 0xF2:
L_urx_2189:
;Master.c,714 :: 		break;
	GOTO	L_urx_2187
;Master.c,715 :: 		case 0xF3:
L_urx_2190:
;Master.c,716 :: 		InterrupcionP1(0xB3,subFuncionRS485,numDatosRS485);
	MOV	#lo_addr(_subFuncionRS485), W0
	MOV	_numDatosRS485, W12
	MOV.B	[W0], W11
	MOV.B	#179, W10
