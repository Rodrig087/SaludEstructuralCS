...
; j start address is: 4 (W2)
	CP.B	W2, #9
	BRA LTU	L__ADXL355_read_data201
...
;Master.c,238 :: 		void EnviarTramaUART(unsigned short puertoUART, unsigned short direccion, unsigned short numDatos, unsigned short funcion, unsigned char *payload){
; payload start address is: 4 (W2)
	MOV	[W14-8], W2
;Master.c,242 :: 		if (puertoUART == 1){
	CP.B	W10, #1
	BRA Z	L__EnviarTramaUART209
	GOTO	L__EnviarTramaUART118
L__EnviarTramaUART209:
;Master.c,243 :: 		UART1_Write(0x3A);                                                      //Envia la cabecera de la trama
	PUSH	W10
	MOV	#58, W10
	CALL	_UART1_Write
;Master.c,244 :: 		UART1_Write(direccion);                                                 //Envia la direccion del destinatario
	ZE	W11, W10
	CALL	_UART1_Write
;Master.c,245 :: 		UART1_Write(numDatos);                                                  //Envia el numero de datos
	ZE	W12, W10
	CALL	_UART1_Write
;Master.c,246 :: 		UART1_Write(funcion);                                                   //Envia el codigo de la funcion
	ZE	W13, W10
	CALL	_UART1_Write
	POP	W10
;Master.c,247 :: 		for (iDatos=0;iDatos<numDatos;iDatos++){                                //Envia la carga util de datos
...
; payload start address is: 4 (W2)
	ZE	W12, W0
	CP	W1, W0
	BRA LTU	L__EnviarTramaUART210
	GOTO	L_EnviarTramaUART30
L__EnviarTramaUART210:
;Master.c,248 :: 		UART1_Write(payload[iDatos]);
	ADD	W2, W1, W0
	PUSH	W10
	ZE	[W0], W10
	CALL	_UART1_Write
...
;Master.c,249 :: 		}
; iDatos end address is: 2 (W1)
	GOTO	L_EnviarTramaUART29
L_EnviarTramaUART30:
;Master.c,250 :: 		UART1_Write(0x0D);                                                      //Envia el primer delimitador de final de la trama
	PUSH	W10
	MOV	#13, W10
	CALL	_UART1_Write
;Master.c,251 :: 		UART1_Write(0x0A);                                                      //Envia el segundo delimitador de final de la trama
	MOV	#10, W10
	CALL	_UART1_Write
; payload end address is: 4 (W2)
	POP	W10
	MOV	W2, W1
;Master.c,252 :: 		}
	GOTO	L_EnviarTramaUART28
L__EnviarTramaUART118:
;Master.c,242 :: 		if (puertoUART == 1){
	MOV	W2, W1
;Master.c,252 :: 		}
L_EnviarTramaUART28:
;Master.c,254 :: 		if (puertoUART == 2){
; payload start address is: 2 (W1)
	CP.B	W10, #2
	BRA Z	L__EnviarTramaUART211
	GOTO	L_EnviarTramaUART32
L__EnviarTramaUART211:
;Master.c,255 :: 		UART2_Write(0x3A);                                                      //Envia la cabecera de la trama
	PUSH	W10
	MOV	#58, W10
	CALL	_UART2_Write
;Master.c,256 :: 		UART2_Write(direccion);                                                 //Envia la direccion del destinatario
	ZE	W11, W10
	CALL	_UART2_Write
;Master.c,257 :: 		UART2_Write(numDatos);                                                  //Envia el numero de datos
	ZE	W12, W10
	CALL	_UART2_Write
;Master.c,258 :: 		UART2_Write(funcion);                                                   //Envia el codigo de la funcion
	ZE	W13, W10
	CALL	_UART2_Write
	POP	W10
;Master.c,259 :: 		for (iDatos=0;iDatos<numDatos;iDatos++){                                //Envia la carga util de datos
...
; payload end address is: 2 (W1)
	ZE	W12, W0
	CP	W2, W0
	BRA LTU	L__EnviarTramaUART212
	GOTO	L_EnviarTramaUART34
L__EnviarTramaUART212:
; payload end address is: 2 (W1)
;Master.c,260 :: 		UART2_Write(payload[iDatos]);
; payload start address is: 2 (W1)
	ADD	W1, W2, W0
	PUSH	W10
	ZE	[W0], W10
...
; payload end address is: 2 (W1)
; iDatos end address is: 4 (W2)
	GOTO	L_EnviarTramaUART33
L_EnviarTramaUART34:
;Master.c,262 :: 		UART2_Write(0x0D);                                                      //Envia el primer delimitador de final de la trama
	PUSH	W10
	MOV	#13, W10
	CALL	_UART2_Write
;Master.c,263 :: 		UART2_Write(0x0A);                                                      //Envia el segundo delimitador de final de la trama
	MOV	#10, W10
	CALL	_UART2_Write
	POP	W10
;Master.c,264 :: 		}
